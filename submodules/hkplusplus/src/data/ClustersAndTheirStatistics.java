...
public class ClustersAndTheirStatistics<PROBLEM extends BaseProblemRepresentation> {
	...
	public void calculateInternalMeasures(QualityMeasure clusterWeightQualityMeasure, ParameterSet<Integer, PROBLEM> parameters) {
//		calculateWholeHierarchyMeasures();
		calculateClusterWeights(clusterWeightQualityMeasure, parameters);
	}

	private void calculateClusterWeights(QualityMeasure clusterWeightQualityMeasure, ParameterSet<Integer, PROBLEM> parameters) {
		...
		// TODO: instead of considering just one objectve value, we could use euclidean distance
